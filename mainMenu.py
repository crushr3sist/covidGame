...
def menuScreen():
    ...
    four=makeLabel("The further you go, the harder it gets!", 50, 50, 650, fontColour='black', font='Helvetica', background='clear')
    three=makeLabel("Cure patients that are sick by handing", 50, 50, 500, fontColour='black', font='Helvetica',background='clear')
    two=makeLabel("Collect masks by walking over the box", 50, 50, 400, fontColour='black', font='Helvetica', background='clear')
    one=makeLabel("Press the arrow keys to move", 50, 50, 300, fontColour='black', font='Helvetica', background='clear')
    five = makeLabel("them masks (walking over them)", 50, 50, 550, fontColour='black', font='Helvetica',background='clear')
    six = makeLabel("Instructions:", 150, 50, 25, fontColour="black",font='Helvetica',background ='clear')
    seven = makeLabel("Press any key to continue", 50, 50, 750, fontColour='black', font='Helvetica',background='clear')
    four2=makeLabel("If you leave the patients for", 50, 50, 50, fontColour='black', font='Helvetica', background='clear')
    four3=makeLabel("too long, they die!", 50, 50, 100, fontColour='black', font='Helvetica', background='clear')
    three2=makeLabel("If a patient dies, you lose a heart", 50, 50, 200, fontColour='black', font='Helvetica',background='clear')
    two2=makeLabel("Time is counted by movements, meaning", 50, 50, 300, fontColour='black', font='Helvetica', background='clear')
    one2=makeLabel("you can decide your strategy to win!", 50, 50, 350, fontColour='black', font='Helvetica', background='clear')
